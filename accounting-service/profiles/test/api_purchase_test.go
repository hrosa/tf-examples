...
func RunApiPurchasesTestsuite(t *testing.T) {
	RunTestGroup(t, "./test_api_purchase", []func(t *testing.T){queryAllScenario, querySingleScenario})
}

func queryAllScenario(t *testing.T) {
	// GIVEN
...
func querySingleScenario(t *testing.T) {
	// GIVEN
	// Get contextual data from TF output
	terraformOptions := &terraform.Options{
		TerraformDir:       "./test_api_purchase",
